...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleLyric({lineNum,txt}) { //歌词滚动效果
      ...
      middleTouchMove(e) {
        ...
        const touch = e.touches[0]
        const deltaX = touch.pageY - this.touch.startX
        const deltaY = touch.pageY - this.touch.startY
        if (Math.abs(deltaY) > Math.abs(deltaY)) {//Math.abs 返回绝对值 
          return 
        }
